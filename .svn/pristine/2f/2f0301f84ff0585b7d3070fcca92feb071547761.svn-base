    ...
    angular.module("app")
        .service("courseService1", ["$window", function ($window) {
            ...
            this.getLearnScore = function () {
                ...
                for (var i = 0; i < this.learn.questions.length; i++) {
                    if (this.learn.questions[i].type == "question") {
                        ...
                        if (this.learn.questions[i].firstAnswerStatus == -1 ||
                            this.learn.questions[i].firstAnswerStatus == 1)
            ...
            this.checkLearnQuestionAnswer = function (question) {
                ...
                if (!question.isFirstAnswer){
                    question.isFirstAnswer = true;
                    question.firstAnswerStatus = question.answerStatus;
                }
            }
