(function() {
    angular.module("app")
    .service("dataShareService", ["dataService", "storeService", "$state", "$q",
        function (dataService, storeService, $state, $q) {
            // 热门课程
            this.hotCourseList = [];
            ...
            var _courseClassify=null;

            this.getCourseClassify = function(){

                var defer = $q.defer();
                if (_courseClassify == null){
