    ...
    angular.module("app")
        .service("dataService", ["$http", "$q", "$cacheFactory", "$window", "myConfig", "storeService", "$log",
            function ($http, $q, $cacheFactory, $window, myConfig, storeService, $log) {
                ...
                //     account: "ljx",
                //     userName: "",
                //     token: "7c3ba5ae-ce41-4ff9-8e6b-f9c8a7f5c6bf"
                // };
                ...
                // start        开始索引(int)
                // limit        查询数量(int)
                this.getCourseNodeSimpleDetialList = function (data) {
                    var defer = $q.defer();
                    var url = myConfig.serviceUrl + '/App/getCourseNodeSimpleDetialList';
                    $http.post(url, data)
                        .then(function (args) {
                            var obj = args.data;
                            if (obj.isSuccess === true) {
                ...
                // data 对象属性
                // parentId        父节点Id(string)
                this.getCourseNodeSimpleDetialCount = function (data) {
                    var defer = $q.defer();
                    var url = myConfig.serviceUrl + '/App/getCourseNodeSimpleDetialCount';
                    $http.post(url, data)
                        .then(function (args) {
                            var obj = args.data;
                            if (obj.isSuccess === true) {
